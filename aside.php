...
<label for="nav-toggle" class="nav-overlay no-print"></label>
 <aside class="sidebar">
          ...
          <ul>
            ...
            <li><a href="tel:<?php echo $profile['phone_raw']; ?>" target="_blank" class="big"><?php echo $profile['phone']; ?></a><a href="https://wa.me/<?php echo $profile['whatsapp']; ?>" target="_blank" title="WhatsApp" class="no-print"
            ...
            <li><strong><em><a href="mailto:<?php echo $profile['email']; ?>" target="_blank" class="big"><?php echo $profile['email']; ?></a></em></strong>
            </li>
          </ul>
          <ul id="menu-social" class="social-links-menu">
            <li><a href="<?php echo $profile['linkedin']; ?>" title="linkedin profile"
            ...
            <li><a href="<?php echo $profile['github']; ?>" title="github repositories" target="_blank"><span>Github</span><svg

...
$targets = [
    ...
    'generic' => [
        ...
        'intro_bio' => 'Senior Engineer with over 20 years of experience building high-performance digital ecosystems. Expert in modern Front-End architecture and high-fidelity UI implementation.',
        ...
        'intro_bio_4' => 'Expert in <strong>AI-Assisted Development</strong>. I leverage <strong>Cursor</strong>, <strong>VS Code</strong>, and <strong>Antigravity</strong> using advanced models to accelerate production. I specialize in prompt engineering for complex refactoring and building sustainable, high-performance systems.',
        'tech_stack' => '<strong>HTML5</strong>, <strong>CSS3/SASS</strong>, JavaScript, TypeScript, <strong>Figma</strong>, <strong>AI (Cursor/Copilot)</strong>, Responsive Design, VueJS, Angular, NodeJS, npm, GIT, SCRUM, modern PHP, WordPress, API Rest, MySQL, Python, SEO',
        ...
        'letter_body' => [
            'I am writing to express my strong interest in joining your team as a <strong>Senior Front-End Engineer</strong>. With over two decades of experience navigating the evolution of the web, I have developed a unique profile that bridges the gap between sophisticated UI/UX design and robust, scalable engineering.',
    ...
    'wordpress' => [
        'company' => 'WordPress & Laravel Specialist',
        'intro_title' => 'Senior WordPress & Laravel Engineer',
        'intro_bio' => 'Senior WordPress & Laravel Architect with 20+ years of experience building high-scale, custom digital solutions. Expert in developing bespoke themes, plugins, and <strong>Laravel</strong>-powered backends from the ground up.',
    ...
    'laravel' => [
        ...
        'intro_bio_4' => 'Expert in <strong>AI-Assisted Development</strong> using <strong>Cursor</strong> and <strong>GitHub Copilot</strong> to accelerate PHP refactoring, generate migrations, and maintain clean <strong>SOLID</strong> architectures at scale.',
    ...
    'laravel-timber' => [
        ...
        'intro_bio_4' => 'Expert in <strong>AI-Assisted Development</strong> using <strong>Cursor</strong> and <strong>GitHub Copilot</strong> to accelerate PHP refactoring, scaffold Laravel modules, and maintain clean <strong>SOLID</strong> architectures in complex full-stack environments.',
        ...
        'letter_body' => [
            ...
            'I leverage <strong>AI-assisted development tools</strong> such as Cursor and GitHub Copilot to accelerate development and maintain architectural consistency. I thrive in remote-first Agile environments and am confident I can contribute from day one to a team that demands technical excellence in the PHP and WordPress ecosystem.'
        ]
    ],
    ...
    'sgtech' => [
        ...
        'intro_bio_4' => 'Expert in <strong>AI-Assisted Development</strong> (Cursor/Copilot) for complex refactoring and architecture. I excel at translating <strong>APIs REST</strong> into modular, maintainable frontend systems.',
        ...
        'letter_body' => [
            ...
            'My approach combines deep technical expertise with <strong>AI-assisted development</strong> (using tools like Cursor) to accelerate production without compromising code quality. I am highly comfortable in 100% remote, Agile environments, utilizing Git and Jira for seamless team collaboration.',

<section id="experience" class="page">
  ...
  <article>
    ...
    <p><strong>Fullstack WordPress developer en ByteBerry</strong> 
      (<a href="//byteberry.studio" target="_blank">byteberry.studio</a>)<br />
      Desarrollo en varios proyectos de webs corporativas (maquetaciones complejas, animaciones, microinteracciones, Javascript,...).
      <br />
      <small>WordPress, PHP, Javascript, MySQL, Symphony, Webpack, Tailwind, Twig, Figma, HTML, CSS/SASS, ACF, Polylang, GIT, ...</small>
    </p>

    <p><strong>FrontEnd developer en Minsait</strong> 
      (<a href="//indracompany.com/es/minsait" target="_blank">indracompany.com</a>)<br />
      Mantenimiento y desarrollo de nuevas funcionalidades de la web de la Fundación BBVA (<a href="//fbbva.es" target="_blank">fbbva.es</a>)
      <br />
      <small>Openweb, WordPress, PHP, Javascript, MySQL, Figma, HTML, CSS/SASS, ACF, Polylang, GIT, ...</small>
    </p>

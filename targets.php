...
$targets = [
    ...
    'generic' => [
        ...
        'tech_stack' => '<strong>React</strong>, <strong>HTML5</strong>, <strong>CSS3/SASS</strong>, JavaScript, TypeScript, <strong>Figma</strong>, <strong>AI (Cursor/Copilot)</strong>, Responsive Design, VueJS, Angular, NodeJS, npm, GIT, SCRUM, modern PHP, WordPress, API Rest, MySQL, Python, SEO',

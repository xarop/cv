<section id="experience" class="page">
  ...
  <article>
    ...
    <p><strong>Senior Web Engineer at ByteBerry</strong> 
      (<a href="//byteberry.studio" target="_blank">byteberry.studio</a>)<br />
      Architecting enterprise-level WordPress ecosystems, focusing on high-performance Gutenberg blocks, React-based UI components, and complex backend integrations. Lead developer for high-traffic corporate websites requiring advanced animations and sub-second load times.
      <br />
      <small>WordPress Architecture, modern PHP (OOP), React.js, Gutenberg Blocks, Timber/Twig, Tailwind CSS, Redis, CI/CD, GIT.</small>
    </p>

    <p><strong>FrontEnd Engineer at Minsait (Indra)</strong> 
      (<a href="//indracompany.com/es/minsait" target="_blank">indracompany.com</a>)<br />
      Development of the BBVA Foundation digital ecosystem. Focused on modular component architecture and implementing complex editorial workflows within WordPress.
      <br />
      <small>WordPress, PHP, Javascript, MySQL, Figma, HTML, CSS/SASS, ACF, Polylang, GIT, ...</small>
    </p>


    <p><strong>Lead Web Developer at BeeData analytics</strong> 
      (<a href="//beedataanalytics.com/" target="_blank">beedataanalytics.com</a>)<br />
      Engineered advanced data-visualization reports and custom webapps for utility companies. Integrated complex D3.js visualizations with backend data pipelines.
      <br />
      <small>BigData, React, D3.js, WordPress, Python, PDF Generation, Performance Tuning.</small>
    </p>

    <p><strong>FrontEnd Developer for Grupo Planeta</strong> 
      (<a href="//www.casadellibro.com/" target="_blank">casadellibro.com</a> and <a href="//www.eae.es/"
        target="_blank">eae.es</a>)<br />
      Core developer for the new digital platforms of Casa del Libro and EAE Business School, handling high-concurrency traffic and complex e-commerce requirements.
      <br />
    ...
    <p>
      ...
      <small>Diseño, maquetación <em>ecommerce</em></small><br />
      ...
      <a href="//ludikstudio.com/" target="_blank">ludikstudio.com</a>
      <small>Diseño y desarrollo web.</small><br />
      <a href="//paumirabet.com/" target="_blank">paumirabet.com</a>
      <small>Diseño y desarrollo web.</small><br />
  ...
  <article>
    ...
    <p><strong>Diseño y desarrollo del <em>website</em> de <a href="//www.adamo.es/"
      ...
      Diseño y desarrollo del UI utilizando Bootstrap y Less, GoogleMaps y formularios.<br />
    ...
    <p><strong><em>UI designer</em> en <a title="" href="//www.infojobs.net/" target="_blank">Infojobs.<br />
        ...
        target="_blank">infojobs.net</a>.<br />
    ...
    <p></p>
    <p class="no-print"><strong>Implementación de <em>WordPress</em></strong> para <a href="//www.volotea.com/"
...
<section id="experience2" class="page">
  <article>
...
<div class="row">
  ...
  <section id="skills" class="page">
    ...
    <table class="skill">
      ...
      <tr>
        <td class="first">Bootstrap / Tailwind</td>
        <td><span style="width:90%;"><span></td>
        <td class="last">9/10</td>
      </tr>
      <!-- <tr>
